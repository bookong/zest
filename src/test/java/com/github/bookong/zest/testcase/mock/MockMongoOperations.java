 ...
 * @author Jiang Xu
 */
public class MockMongoOperations implements MongoOperations {
    ...
    @Override
    public <T> com.mongodb.client.MongoCollection<Document> createCollection(Class<T> entityClass) {
        return null;
    }

    @Override
    public <T> com.mongodb.client.MongoCollection<Document> createCollection(Class<T> entityClass, CollectionOptions collectionOptions) {
        return null;
    }

    @Override
    public com.mongodb.client.MongoCollection<Document> createCollection(String collectionName) {
        return null;
    }

    @Override
    public com.mongodb.client.MongoCollection<Document> createCollection(String collectionName, CollectionOptions collectionOptions) {
        return null;
    }
    ...
    @Override
    public <T> MapReduceResults<T> mapReduce(Query query, String inputCollectionName, String mapFunction, String reduceFunction, MapReduceOptions mapReduceOptions,
                                             Class<T> entityClass) {
        return null;
    }
